\subsection{Cifrario a Shift}
    ...
    \subsection{Cifrario affine}
        ...
        \begin{definition}[Funzione di Eulero]
            Siano $a,m \in \mathbb{Z}. \ a\geq 1, m \geq 2$ Se MCD$(a,m) = 1$ $a$ e $m$ si dicono \textit{co-primi} tra loro. Il numero di interi in $\mathbb{Z}_m$ co-primi con $m$ è scritto come $\phi(m)$ \textit{(funzione di Eulero)} 
        \end{definition}
